...
#    print("Exiting\n")
    os._exit(0)  
timer = threading.Timer(20.0, gfg)
timer.start()
'''

os.environ['GOOGLE_APPLICATION_CREDENTIALS']="/home/shaik/Desktop/service_account.json"
...
def listen_print_loop(responses):
    ...
    for response in responses:
        ...
        if not result.is_final:
          ...
          ###  search_string = "r\'\b(forecast|cloudy|rain|weather|Bangalore)\b\'"

            if re.search(conditions, transcript, re.I):
		if sys.argv[3] == '0':
		...
		os.system('echo test case failed | festival --tts')
		outfile =  open ("result_file.txt","w+")
