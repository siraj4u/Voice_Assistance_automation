...
### sys.argv[1] command for asking about something
### sys.argv[2] command for set the volume
...
'''
settings.vam_wake_word_generation(sys.argv[3])  ### calling function for wake word generation
settings.vam_command_generation(sys.argv[1],0)  ### calling function for the command generation
subprocess.call(['python','vam_loudness_mic.py']) ###python script of calculate amplitudes
...
###script for calculating both amplitude levels
subprocess.call(['python','vam_volume_down_checker.py'])
